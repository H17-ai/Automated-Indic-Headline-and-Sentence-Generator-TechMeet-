...
def load_model(model_weights_path:str):
    ...
    hi_en_char_vocab = load_vocab('models/hinglish_vocab.pkl')
    hi_char_vocab = load_vocab('models/hindi_vocab.pkl')
...
if __name__ == "__main__":
    ...
    # print(str(transliterator.transliterate("ajeeb")).encode('unicode-escape'))